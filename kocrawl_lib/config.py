...
SEARCH = {
    'url': {
        ...
        'naver_course': 'https://map.naver.com/v5/api/search?caller=pcweb&query=',
...
ANSWER = {
    ...
    'map_init': '{location}에 위치한 여행지 정보를 물어보셨군요! 😉😉\n',
    'map_init_theme': '{location}에 위치한 {theme}에 대한 여행지 정보를 물어보셨군요! 😉😉\n',
    'course_init': '{location}에 위치한 {theme} 여행지 코스 정보를 물어보셨군요! 😉😉\n',
